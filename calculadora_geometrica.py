...
print("\nLa Calculadora Geometrica maneja la unidad de longitud Centimetro (cm)")
opcion = 0
while opcion != 10:
    ...
    if entrada == "rectangulo" or entrada == "1":
        ...
        if operacion == "area" or operacion == "1":
            entrada = input("Selecciona la variable a averiguar\n"\
                        ...
                        "-> ").lower()
            # operacion area
            if entrada == "base" or entrada == "1": # si se quiere calcular la base 
            ...
            elif entrada == "altura" or entrada == "2": # si se quiere calcular la altura
                b = float(input("Ingrese el valor de la base (float): "))
                a = float(input("Ingrese el valor del area (float): "))
                h = a / b
                print(f"Resultado Altura = {h:.2f} cm")

            elif entrada == "area" or entrada == "3": # si se quiere calcular el area
                b = float(input("Ingrese el valor de la base (float): "))
                h = float (input("Ingrese el valor de la altura (float): "))
                a = b * h           
        ...
        # operaacion diagonal
            ...
            entrada = input("Selecciona la variable a averiguar\n"\
                        ...
                        "3. Altura\n"\
                        "-> ").lower()
            if entrada == "diagonal" or entrada == "1":
                b = float(input("Ingrese el valor de la base (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
                d = ((b ** 2) + (h ** 2)) ** (1 / 2)
    ...
    # operaciones del triangulo
        ...
        if operacion == "area" or operacion == "1":
            ...
            if entrada == "perimetro" or entrada == "1":
                ...
                p = a + b + c
                print(f"Resultado Perimetro = {p:.2f} cm")
            elif entrada == "lado a" or entrada == "2":
                b = float(input("Ingrese el valor del lado b (float): "))
                c = float(input("Ingrese el valor del lado c (float): "))
                p = float(input("Ingrese el valor del perimetro (float): "))
                a = p - b - c
            ...
            elif entrada == "lado b" or entrada == "3":
                a = float(input("Ingrese el valor del lado a (float): "))
                c = float(input("Ingrese el valor del lado c (float): "))
                p = float(input("Ingrese el valor del perimetro (float): "))
                b = p - a - c
            ...
            elif entrada == "lado c" or entrada == "4":
                a = float(input("Ingrese el valor del lado a (float): "))
                b = float(input("Ingrese el valor del lado b (float): "))
                p = float(input("Ingrese el valor del perimetro (float): "))
                c = p - a - b
            ...
            entrada = input("Selecciona el angulo a averiguar\n" \
                        "1. A\n" \
                        "2. B\n" \
                        "3. C\n" \
                        "-> ").lower()
            if entrada == "a" or entrada == "1":
    ...
    # operaciones del circulo
        ...
        if operacion == "area" or operacion == "1":
            ...
            if entrada == "area" or entrada == "1":
                ...
                a = 3.14 * (r ** 2)
                print(f"Resultado Area = {a:.2f} cm^2")
            elif entrada == "radio" or entrada == "2":
                a = float(input("Ingrese el valor del area (float): "))
                r = (a / 3.14) ** (1 / 2)
            ...
            if entrada == "circunferencia" or entrada == "1":
                r = float(input("Ingrese el valor del radio (float): "))
                c = 2 * 3.14 * r
            ...
            elif entrada == "diametro" or entrada == "3":
                c = float(input("Ingrese el valor de la circunferencia (float): "))
                d = c / 3.14
            ...
            entrada = input("Selecciona la variable a averiguar\n" \
                        ...
                        "2. Diametro\n" \
                        "-> ").lower()
            if entrada == "radio" or entrada == "1":
                d = float(input("Ingrese el valor del diametro (float): "))
                r = d / 2
                print(f"Resultado Radio = {r:.2f} cm")
            
            elif entrada == "diametro" or entrada == "2":
                r = float(input("Ingrese el valor del radio (float): "))
                d = r * 2
    ...
    # operaciones del trapecio
        ...
        if operacion == "area" or operacion == "1":
            entrada == input("Selecciona la variable a averiguar\n" \
                        ...
                        "4. Area" \
                        "-> ").lower()
            if entrada == "base mayor" or entrada == "1":
                a = float(input("Ingrese el valor del area (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
            ...
            elif entrada == "base menor" or entrada == "2":
                a = float(input("Ingrese el valor del area (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
            ...
            elif entrada == "area" or entrada == "4":
                b_mayor = float(input("Ingrese el valor de la base mayor (float): "))
                b_menor = float(input("Ingrese el valor de la base menor (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
        ...
        if operacion == "perimetro" or operacion == "2":
            ...
            if entrada == "perimetro" or entrada == "1":
                ...
                print(f"Resultado Perimetro = {p:.2f} cm")
            elif entrada == "base mayor" or entrada == "2":
                b_menor = float(input("Ingrese el valor de la base menor (float): "))
                lado_1 = float(input("Ingrese el valor del lado 1 (float):  "))
                lado_2 = float(input("Ingrese el valor del lado 2 (float):  "))
                p = float(input("Ingrese el valor del perimetro (float):  "))
            ...
            elif entrada == "base menor" or entrada == "3":
                b_mayor = float(input("Ingrese el valor de la base mayor (float): "))
                lado_1 = float(input("Ingrese el valor del lado 1 (float):  "))
                lado_2 = float(input("Ingrese el valor del lado 2 (float):  "))
                p = float(input("Ingrese el valor del perimetro (float):  "))
            ...
            elif entrada == "lado 1" or entrada == "4":
                lado_2 = float(input("Ingrese el valor del lado 2 (float):  "))
                b_mayor = float(input("Ingrese el valor de la base mayor (float): "))
                b_menor = float(input("Ingrese el valor de la base menor (float): "))
                p = float(input("Ingrese el valor del perimetro (float):  "))
            ...
            elif entrada == "lado 2" or entrada == "5":
                b_mayor = float(input("Ingrese el valor de la base mayor (float): "))
                b_menor = float(input("Ingrese el valor de la base menor (float): "))
                lado_1 = float(input("Ingrese el valor del lado 1 (float):  "))
                p = float(input("Ingrese el valor del perimetro (float):  "))
    ...
    # operaciones de la esfera
        ...
        if operacion == "volumen" or operacion == "1":
            entrada = input("Selecciona la variable a averiguar\n" \
                        ...
                        "2. Radio\n" \
                        "-> ").lower()
            if entrada == "volumen" or operacion == "1":
                r = float(input("Ingrese el valor del radio (float): "))
                v = (4 / 3) * (3.14 * (r ** 3))
            ...
            if entrada == "area" or operacion == "1":
                r = float(input("Ingrese el valor del radio (float): "))
                a = 4 * 3.14 * (r ** 2)
    ...
    # operaciones del cilindro
        ...
        if operacion == "volumen" or operacion == "1":
            entrada = input("Selecciona la variable a averiguar\n" \
                        ...
                        "3. Altura\n" \
                        "-> ").lower()
            if entrada == "volumen" or entrada == "1":
                r = float(input("Ingrese el valor del radio (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
                v = 3.14 * (r ** 2) * h
                print(f"Resultado Volumen = {v:.2f} cm^3")
            
            elif entrada == "radio de base" or entrada == "2":
                v = float(input("Ingrese el valor del volumen (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
                r = (v / (3.14 * h)) ** (1 / 2)
                print (f"Resultado Radio = {r:.2f} cm")
            ...
            entrada = input("Selecciona la variable a averiguar\n" \
                        ...
                        "3. Altura\n" \
                        "-> ").lower()
            if entrada == "area lateral" or entrada == "1":
                r = float(input("Ingrese el valor del radio (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
            ...
            entrada = input("Selecciona la variable a averiguar\n" \
                        ...
                        "3. Altura\n" \
                        "-> ").lower()
            if entrada == "area total" or entrada == "1":
                r = float(input("Ingrese el valor del radio (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
    ...
    # operaciones del cono
        ...
        #
            ...
            elif entrada == "generatriz" or entrada == "3":
                a_lateral = float(input("Ingrese el valor del area lateral (float): "))
                r = float(input("Ingrese el valor del radio (float): "))
                h = a_lateral / (3.14 * r)
                print(f"Resultado Altura = {h:.2f} cm")
    ...
    # operaciones de la piramide
        ...
        if operacion == "volumen" or operacion == "1":
            ...
            elif entrada == "area base" or entrada == "2":
                v = float(input("Ingrese el valor del volumen (float): "))
                h = float(input("Ingrese el valor de la altura (float): "))
                a_base = (3 * v) / h
            ...
            elif entrada == "area lateral" or entrada == "3":
                a_total = float(input("Ingrese el valor del area total (float): "))
    ...
    # teorema de pitagoras
            ...
            entrada = input("Selecciona la variable a averiguar\n"\
                        ...
                        "3. Hipotenusa\n"\
                        "-> ").lower()
            if entrada == "cateto a" or entrada == "1":
